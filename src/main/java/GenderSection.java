...
//    private final By maleRadioButton = By.id("");   CSS den aldigimiz icin asagidaki gibi olacak
//    private final By femaleRadioButton = By.id("");
//    private final By otherRadioButton = By.id("");
